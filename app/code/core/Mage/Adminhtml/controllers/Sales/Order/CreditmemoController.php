...
class Mage_Adminhtml_Sales_Order_CreditmemoController extends Mage_Adminhtml_Controller_Sales_Creditmemo
{
    ...
    public function saveAction()
    {
        ...
        try {
            ...
            if ($creditmemo) {
                ...
                // Craftsvilla Comment Added By Dileswar For Function Refund amount SMS On dated 16-11-2012
				$this->smsRefund($creditmemo->getData('order_id'));
	...
	// Function for smsRefund Added By Dileswar on dated 16-11-2012
	
	protected function smsRefund($_oid){
		...
		$_grandrefundTotal = $_order->getBaseTotalRefunded();
		...
		$customerMessage = 'Your Order has been Refunded: Order#:'.$orderId.',the Refunded Amount:Rs.'.$_grandrefundTotal.' - Craftsvilla.com (Customercare Email: customercare@craftsvilla.com)';
