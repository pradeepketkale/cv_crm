...
class Mage_Core_Model_Cache
{
    ...
    protected $_allowedCacheOptions = null;
	 ...
	 /** @var Mongo_Client */
		protected $_connectionsmongo = null;
    ...
    public function __construct(array $options = array())
    {
		...
		/** @var Mongo_ClientConnection */        
		try{
		//$this->_connectionsmongo =new MongoClient( "mongodb://10.144.14.224"); 
		}
		catch(Exception $e)
		{
			//echo "Not connecting Mongo db",$e;
		}
		//echo '<pre>';print_r($this->_connectionsmongo);echo 'connecting';
...
/** @var Mongo_Client_connection */

	public function getConnectionMongo()
    {
		if(isset($this->_cache->_connectionsmongo))
			{
				return $this->_cache->_connectionsmongo;
			}
	//$this->_cache->_connectionsmongo = new MongoClient( "mongodb://10.144.14.224");
	return $this->_cache->_connectionsmongo;
	}
