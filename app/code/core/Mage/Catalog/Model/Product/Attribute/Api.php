...
class Mage_Catalog_Model_Product_Attribute_Api extends Mage_Catalog_Model_Api_Resource {
	...
	public function __construct() {
		...
		$this->_ignoredAttributeTypes[] = 'text';
		$this->_ignoredAttributeTypes[] = 'textarea';
		$this->_ignoredAttributeTypes[] = 'date';
		$this->_ignoredAttributeTypes[] = 'boolean';
		$this->_ignoredAttributeTypes[] = 'multiselect';
		$this->_ignoredAttributeTypes[] = 'price';
		$this->_ignoredAttributeTypes[] = 'weee';
	}
