...
class Mage_Catalog_Model_Resource_Eav_Mysql4_Layer_Filter_Price extends Mage_Core_Model_Mysql4_Abstract
{
    ...
    {
        //Changes to cat_index on dated 08-01-2014 [added a new table name catalog_product_craftsvilla.....]
		//return 'price_index';
		return 'e';
    }
...
//commented $additional to avoid tax_class_id...  added on date 08-01-2014
