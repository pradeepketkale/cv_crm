...
//Below line commented on dated 03-03-2014 for reducing query
                ->from(array('default'=>$table), array($entityIdField, 'attribute_id', 'default_value'=>'value','store_value'=>'value' ,'value'=>'value'))
