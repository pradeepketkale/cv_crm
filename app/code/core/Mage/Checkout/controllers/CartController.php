...
class Mage_Checkout_CartController extends Mage_Core_Controller_Front_Action
{
     ...
     */
    protected function _initProduct1()
    {
...
protected function _initProduct()
    {
        $productId = (int) $this->getRequest()->getParam('product');
		if ($productId) {
			if(Mage::helper('catalog/product')->getProductTypeId($productId) == 'configurable')
			{
        ...
        try {
            ...
            if (is_array($cartData)) {
                ...
                if (isset($data['custom'])) {
                	//$_eQuoteId = $this->_getCart()->getQuote()->getEntityId();
                	$setItemCollection = Mage::getModel('sales/quote_item')->load($index);//->getSelect()->where('main_table.product_id= "'.$index.'" AND main_table.quote_id= "'.$_eQuoteId.'" ');
                	//echo '<pre>';print_r($setItemCollection->getData());exit;
                	$setItemCollection->setAdditionalData($data['custom']);
                	//echo '<pre>';print_r($setItemCollection->getData());exit;
                	}
                }
                $cart = $this->_getCart();
