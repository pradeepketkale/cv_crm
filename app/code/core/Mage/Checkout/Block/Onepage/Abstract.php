    ...
    public function getAddressesHtmlSelect($type)
    {
        if ($this->isCustomerLoggedIn()) {
            ...
            $select = $this->getLayout()->createBlock('core/html_select')
                 ...
                 * Craftsvilla Comment:-
                 * Suresh(10-05-2012)
                 * for get value of option to change address and display onchange select box.
                */
                ->setExtraParams('onchange="'.$type.'.newAddress(!this.value)"')
                //->setExtraParams('onchange="'.$type.'.newAddress(this.options[this.selectedIndex].value)"')
                /*
                 * End
                 * Craftsvilla Comment:-
                 * Suresh(10-05-2012)
