 ...
 */
class Innoexts_CurrencyPricing_Model_Mysql4_Downloadable_Indexer_Price extends Mage_Downloadable_Model_Mysql4_Indexer_Price
{
    /**
    ...
    protected function _applyDownloadableLink()
    {
        ...
        if ($this->getVersionHelper()->isGe1600()) {
            ...
            $dlpdPrice = $this->getCurrencyPriceExpr(null, $dlpdPrice, $rate);
            ...
            $dlpwPrice = $this->getCurrencyPriceExpr(null, $dlpwPrice, $rate);
            $dlpdPrice = new Zend_Db_Expr('dlpd.price');
            $dlpdPrice = $this->getCurrencyPriceExpr(null, $dlpdPrice, $rate);
        ...
        $select = $write->select()
            ...
            ->where('dl.value = ?', 1)
            ->group(array('i.entity_id', 'i.customer_group_id', 'i.website_id', 'i.currency'))
            ->columns(array(
                'min_price' => $minPrice, 
                'max_price' => $maxPrice, 
                'currency'  => 'i.currency'
