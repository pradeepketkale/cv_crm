...
/**
 * Product currency price tab renderer
 * 
 * @category   Innoexts
 * @package    Innoexts_CurrencyPricing
 * @author     Innoexts Team <developers@innoexts.com>
 */
class Innoexts_CurrencyPricing_Block_Adminhtml_Catalog_Product_Edit_Tab_Currency_Price_Renderer 
    ...
    implements Varien_Data_Form_Element_Renderer_Interface 
{
    ...
    public function __construct() {
        $this->setTemplate('currencypricing/catalog/product/edit/tab/currency/price/renderer.phtml');
    }
    /**
     * Get default price
     * 
    ...
    /**
     * Get default currency price
     * 
     * @param string 
     * @return float
     */
    public function getDefaultCurrencyPrice($currency)
    {
    ...
    public function getValues()
    {
        ...
        if (count($currencies)) {
            ...
            foreach ($currencies as $currency) {
                ...
                $defaultPrice = $helper->getEscapedPrice($this->getDefaultCurrencyPrice($currency));
