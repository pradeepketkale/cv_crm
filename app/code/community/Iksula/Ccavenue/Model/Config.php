 ...
 */
/**
 * Ccavenue Configuration Model
 *
 * @category   Mage
 * @package    Iksula_Ccavenue
 * @name       Iksula_Ccavenue_Model_Config
 * @author     Magento Core Team <core@magentocommerce.com>
 */

class Iksula_Ccavenue_Model_Config extends Varien_Object
{
    /**
     *  Return config var
     *
    ...
    {
        if (!$this->hasData($key)) {
            $value = Mage::getStoreConfig('payment/ccavenue_standard/'.$key);
 ...
 /**
    ...
    /**
     *  Return Store description sent to Ccavenue
     *
