...
class AW_Helpdeskultimate_Block_Adminhtml_Departments_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function __construct()
    {
        ...
        $this->_formScripts[] = "
            ...
            Validation.add('validate-uniq-email', 'This email is already use for gateway! Please use other email for department.', function(value) {
                var getwayEmails = '" . implode(',', Mage::helper('helpdeskultimate')->getGatewayEmails()) . "';
                getwayEmails = getwayEmails.split(',');
                if(!getwayEmails.include(value))
                    return true;
            });
