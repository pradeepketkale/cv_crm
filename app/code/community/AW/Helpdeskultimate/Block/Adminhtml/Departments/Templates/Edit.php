...
class AW_Helpdeskultimate_Block_Adminhtml_Departments_Templates_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if ($this->getEntity()->getId()) {
            return Mage::helper('helpdeskultimate')->__('Edit Quick Response "%s"', $this->htmlEscape($this->getEntity()->getName()));
        }
        else {
            return Mage::helper('helpdeskultimate')->__('New Quick Response');
        }
