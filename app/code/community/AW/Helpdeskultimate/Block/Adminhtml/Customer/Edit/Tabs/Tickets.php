...
class AW_Helpdeskultimate_Block_Adminhtml_Customer_Edit_Tabs_Tickets extends Mage_Adminhtml_Block_Widget implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _toHtml()
    {
        ...
        $button = $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setClass('add')
                ->setType('button')
                ->setOnClick('window.location.href=\'' . $this->getUrl('helpdeskultimate_admin/ticket/new', array('customer_id' => $id)) . '\'')
                ->setLabel('Create ticket for this customer');
