...
class AW_Helpdeskultimate_Block_Adminhtml_Form_Element_Testconnection extends Mage_Adminhtml_Block_Template
{
    ...
    protected function _construct()
    {
        ...
        $this->_states = array(
            array('value' => AW_Helpdeskultimate_Model_Form_Element_Testconnection::STATUS_SUCCESS, 'label' => $this->__('Succeed'), 'color' => 'green'),
            array('value' => AW_Helpdeskultimate_Model_Form_Element_Testconnection::STATUS_FAIL,    'label' => $this->__('Failed'),    'color' => 'red'),
        );
    }
