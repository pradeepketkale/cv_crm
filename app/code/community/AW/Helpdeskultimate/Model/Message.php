...
class AW_Helpdeskultimate_Model_Message extends AW_Core_Model_Abstract
{
    ...
    public function getTicket()
    {
        if ($this->_ticket) {
            ...
            throw(new Mage_Core_Exception(Mage::helper('helpdeskultimate')->__("Ticket not found for message #" . $this->getId())));
        }
    }
    ...
    public function getParsedContent()
    {
        ...
        //    ->setUseSessionInUrl(false)
                ->setVariables(array('ticket' => $this->getTicket(), 'department' => $this->getTicket()->getDepartment(), 'message' => $this));
        try {
