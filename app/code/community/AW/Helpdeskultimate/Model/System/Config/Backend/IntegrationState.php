    ...
    public function _beforeSave()
    {
        ...
        if (@$data['groups']['modules']['fields']['pq_enabled']['value']) {
            ...
            */
                ...
                if (Mage::getStoreConfig(self::XML_PATH_SELF_ADDRESS)) {
                    Mage::getModel('adminhtml/config_data')
                            ...
                            ->setGroups(array(
                                             'email' => array(
                                                 'fields' => array(
                                                     'recipient_email' => array('value' => Mage::getStoreConfig(self::XML_PATH_SELF_ADDRESS))
                                                 )
                                             )
                                        ))
                            ->save();
            ...
            if (Mage::getStoreConfig(self::XML_PATH_SELF_PQ_ADDRESS) &&
                ...
                Mage::getModel('adminhtml/config_data')
                        ...
                        ->setGroups(array(
                                         'email' => array(
                                             'fields' => array(
                                                 'recipient_email' => array('value' => Mage::getStoreConfig(self::XML_PATH_SELF_PQ_ADDRESS))
                                             )
                                         )
                                    ))
                        ->save();
            ...
            if (
                ...
                Mage::getModel('adminhtml/config_data')
                        ...
                        ->setGroups(array(
                                         'email' => array(
                                             'fields' => array(
                                                 'recipient_email' => array('value' => Mage::getStoreConfig(self::XML_PATH_SELF_CF_ADDRESS))
                                             )
                                         )
                                    ))
                        ->save();
