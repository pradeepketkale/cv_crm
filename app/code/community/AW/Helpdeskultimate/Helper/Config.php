...
{
    const XML_PATH_SERVER = 'helpdeskultimate/imap/server'; // POP3 server
    const XML_PATH_PORT = 'helpdeskultimate/imap/port'; // POP3 server port

    const XML_PATH_LOGIN = 'helpdeskultimate/imap/login'; // POP3 Account login
    const XML_PATH_PASSWORD = 'helpdeskultimate/imap/password'; // POP3 Account password
    const XML_PATH_SSL = 'helpdeskultimate/imap/ssl'; // Use SSL, TLS connection or not
    const XML_PATH_TYPE = 'helpdeskultimate/imap/type'; // Select type - POP3 or IMAP
    ...
    const XML_PATH_USE_CONTACTFORM = 'helpdeskultimate/modules/cf_enabled'; // Enable contact form parser
    const XML_PATH_CONTACTFORM_DISABLE_STANDART_EMAIL = 'helpdeskultimate/modules/cf_disable_email'; // Enable contact form standart messages
    const XML_PATH_CONTACTFORM_SENDER = 'contacts/email/sender_email_identity'; // Contact form sender

    const XML_PATH_USE_PQ = 'helpdeskultimate/modules/pq_enabled'; // Enable pq parser
    const XML_PATH_PQ_SENDER = 'productquestions/email/sender_email_identity'; // pq sender

    const XML_PATH_ALLOWNEW = 'helpdeskultimate/advanced/allownew'; // Allow new tickets from email
    const XML_PATH_ALLOWEXTERNAL = 'helpdeskultimate/advanced/allowexternal'; // Allow external links

    /*General Department settings. This settings does not appear on backend. It necessary for old version compatibility.*/
