...
class Unirgy_Dropship_Block_Vendor_Product_Grid extends Mage_Core_Block_Template
{
    ...
    protected function _applyRequestFilters($collection)
    {
        ...
        if (!is_null($param) && $param!=='') {
            $collection->addAttributeToFilter('vendorsku', array('like'=>$param.'%'));
        }
    ...
    public function getProductCollection()
    {
		...
		$collection->getSelect()->where("udropship_vendor = ".$v->getId());
            // Added below line to get the table catalog_product_entity  on dated 13-01-2013-------------------------------
