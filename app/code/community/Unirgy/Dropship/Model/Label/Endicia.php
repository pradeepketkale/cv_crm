    ...
    implements Unirgy_Dropship_Model_Label_Interface_Carrier
{
    ...
    public function requestLabel($track)
    {
        ...
        $mailClass = !empty($this->_mailClass[$methodCode]) ? $this->_mailClass[$methodCode] : $endiciaData->getEndiciaMailClass();
        ...
        $data = array(
            ...
            'Services' => array(
                'DeliveryConfirmation' => $endiciaData->getEndiciaDeliveryConfirmation() ? 'ON' : 'OFF',
                ...
                'RestrictedDelivery' => $endiciaData->getEndiciaRestrictedDelivery(),
