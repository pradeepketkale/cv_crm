...
#echo "<pre>"; print_r($v->debug()); exit;
            ...
            if ($printLabel) {
                ...
                if ($batch->getShipmentCnt()) {
                    ...
                    if ($r->getParam('use_method_code')) {
                        ...
                        $shipment->getResource()->saveAttribute($shipment, array('udropship_method','udropship_method_description'));
                    }
                } else {
                    if ($batch->getErrors()) {
    ...
    */
    ...
    {
    	echo $this->getLayout()->createBlock('udropship/vendor_shipment_print')->toHtml();
    }
