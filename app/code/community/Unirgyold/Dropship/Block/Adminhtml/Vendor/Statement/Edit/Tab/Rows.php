...
class Unirgy_Dropship_Block_Adminhtml_Vendor_Statement_Edit_Tab_Rows extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        */
        if ($this->getStatement()->getVendor()->getData('statement_tax_in_payout') != 'exclude_hide') {
    	...
    	if ($this->getStatement()->getVendor()->getData('statement_shipping_in_payout') != 'exclude_hide') {
