...
class Unirgy_Dropship_Block_Adminhtml_ReportItem_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        if (Mage::helper('udropship')->isSalesFlat()) {
            ...
            $collection->getSelect()
            	->join(array('oi'=>$res->getTableName('sales/order_item')), 'oi.item_id=main_table.order_item_id', array('discount_amount'=>'oi.base_discount_amount', 'cost'=>'oi.base_cost', 'tax_amount'=>'oi.base_tax_amount'))
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('cost', array(
            ...
            'index' => $this->_useBaseCostColumn ? 'base_cost' : 'cost',
