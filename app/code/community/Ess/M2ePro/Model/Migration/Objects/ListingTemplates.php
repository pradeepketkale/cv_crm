        ...
        while ($oldListingTemplate = $pdoStmt->fetch()) {
            ...
            $newListingTemplate = array(
                ...
                'product_details' => json_encode(array(
                      'product_details_isbn_mode' => $oldListingTemplate['product_details_isbn_src'],
                      'product_details_isbn_cv' => $oldListingTemplate['product_details_isbn_cv'],
                      'product_details_isbn_ca' => $oldListingTemplate['product_details_isbn_ca'],
                      'product_details_epid_mode' => $oldListingTemplate['product_details_epid_src'],
                      'product_details_epid_cv' => $oldListingTemplate['product_details_epid_cv'],
                      'product_details_epid_ca' => $oldListingTemplate['product_details_epid_ca'],
                      'product_details_upc_mode' => $oldListingTemplate['product_details_upc_src'],
                      'product_details_upc_cv' => $oldListingTemplate['product_details_upc_cv'],
                      'product_details_upc_ca' => $oldListingTemplate['product_details_upc_ca'],
                      'product_details_ean_mode' => $oldListingTemplate['product_details_ean_src'],
                      'product_details_ean_cv' => $oldListingTemplate['product_details_ean_cv'],
                      'product_details_ean_ca' => $oldListingTemplate['product_details_ean_ca']
                 )),
