...
class Ess_M2ePro_Model_Synchronization_Tasks_Templates_Revise extends Ess_M2ePro_Model_Synchronization_Tasks
{
    ...
    private function execute()
    {
        ...
        $this->_lockItem->setPercents(self::PERCENTS_START + 1*self::PERCENTS_INTERVAL/10);
        $this->_lockItem->activate();

        $this->executePriceChanged();

        $this->_lockItem->setPercents(self::PERCENTS_START + 2*self::PERCENTS_INTERVAL/10);
        $this->_lockItem->activate();
        ...
        $this->_lockItem->setPercents(self::PERCENTS_START + 6*self::PERCENTS_INTERVAL/10);
        $this->_lockItem->activate();

        $this->executeVariationQtyIsInStockChanged();

        $this->_lockItem->setPercents(self::PERCENTS_START + 7*self::PERCENTS_INTERVAL/10);
        $this->_lockItem->activate();
        ...
        $this->_lockItem->setPercents(self::PERCENTS_START + 3*self::PERCENTS_INTERVAL/10);
        $this->_lockItem->activate();

        $this->executeSubTitleChanged();

        $this->_lockItem->setPercents(self::PERCENTS_START + 4*self::PERCENTS_INTERVAL/10);
        $this->_lockItem->activate();

        $this->executeDescriptionChanged();

        $this->_lockItem->setPercents(self::PERCENTS_START + 5*self::PERCENTS_INTERVAL/10);
        $this->_lockItem->activate();
        ...
        $this->_lockItem->setPercents(self::PERCENTS_START + 8*self::PERCENTS_INTERVAL/10);
        $this->_lockItem->activate();

        $this->executeDescriptionsTemplatesChanged();

        $this->_lockItem->setPercents(self::PERCENTS_START + 9*self::PERCENTS_INTERVAL/10);
        $this->_lockItem->activate();
