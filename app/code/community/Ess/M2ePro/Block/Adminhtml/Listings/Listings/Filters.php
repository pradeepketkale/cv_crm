...
class Ess_M2ePro_Block_Adminhtml_Listings_Listings_Filters extends Mage_Adminhtml_Block_Widget
{
    ...
    {
        //-------------------------------
        $tempData = Mage::getModel('M2ePro/SellingFormatTemplates')->getCollection()->toArray();
        ...
        //-------------------------------
        $tempData = Mage::getModel('M2ePro/DescriptionsTemplates')->getCollection()->toArray();
        ...
        //-------------------------------
        $tempData = Mage::getModel('M2ePro/ListingsTemplates')->getCollection()->toArray();
        ...
        //-------------------------------
        $tempData = Mage::getModel('M2ePro/SynchronizationsTemplates')->getCollection()->toArray();
