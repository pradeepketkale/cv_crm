...
class Ess_M2ePro_Adminhtml_AccountsController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    ...
    public function saveAction()
    {
        ...
        if (isset($data['orders_status_invoice']) && $data['orders_status_invoice'] == "on") {
            $data['orders_status_invoice'] = Ess_M2ePro_Model_Accounts::ORDERS_STATUS_INVOICE_YES;
        } else {
            $data['orders_status_invoice'] = Ess_M2ePro_Model_Accounts::ORDERS_STATUS_INVOICE_NO;
        }

        if (isset($data['orders_status_shipping']) && $data['orders_status_shipping'] == "on") {
            $data['orders_status_shipping'] = Ess_M2ePro_Model_Accounts::ORDERS_STATUS_SHIPPING_YES;
        } else {
            $data['orders_status_shipping'] = Ess_M2ePro_Model_Accounts::ORDERS_STATUS_SHIPPING_NO;
        }
        //--------------------
