...
class Craftsvilla_Uagent_Block_Agent_GridColumnFilter extends Mage_Adminhtml_Block_Widget_Grid_Column_Filter_Select
{
    protected function _getValues()
    {
        return Mage::getSingleton('uagent/source')->setPath('agents')->toOptionHash();
    }
        ...
        if (Mage::getStoreConfigFlag('udropship/vendor/autocomplete_htmlselect')) {
            ...
            <script type="text/javascript">
            	...
            	new Ajax.Autocompleter(
                    ...
                    "'.Mage::getModel('core/url')->getUrl('uagent/index/agentAutocomplete').'",
                    {
