 ...
 */
class Craftsvilla_ReferFriend_Model_Layer extends Varien_Object
{
    /**
    ...
    {
		//$todayDate  = Mage::app()->getLocale()->date()->toString(Varien_Date::DATETIME_INTERNAL_FORMAT); // prepare current date - mrugesh
        $attributes = Mage::getSingleton('catalog/config')
            ->getProductAttributes(); 
        $collection->addAttributeToSelect($attributes)
			//->addAttributeToFilter('product_main_end_date', array('gt'=> $todayDate)) // add end date attribute to filter - mrugesh
            ->addMinimalPrice()
            ->addFinalPrice()
            ->addTaxPercents()
            //->addStoreFilter()
