<?php
class Craftsvilla_ReferFriend_Block_Referral_Accepted extends Mage_Core_Block_Template
{
	...
	protected function _prepareLayout()
	{
		...
		$pager = $this->getLayout()->createBlock('page/html_pager', 'referfriend.referral.statistics.pager')->setCollection($this->getReferrals());
