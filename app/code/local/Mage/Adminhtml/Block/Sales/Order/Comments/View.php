...
class Mage_Adminhtml_Block_Sales_Order_Comments_View extends Mage_Adminhtml_Block_Template
{
    ...
    protected function _prepareLayout()
    {
        ...
        $statusCodRto = Unirgy_Dropship_Model_Source::SHIPMENT_STATUS_COD_RTO;
        $shipmentStatus = array($statusCanceled,$statusCodRto);
        $shipmentId =  $this->getRequest()->getParam('shipment_id');
        $shipment = Mage::getModel('sales/order_shipment')->load($shipmentId);
        $currentShipmentStatusId = $shipment->getUdropshipStatus();
        if(in_array($currentShipmentStatusId,$shipmentStatus)){
