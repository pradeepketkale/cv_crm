...
class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
{
    ...
    public function sendNewAccountEmail($type = 'registered', $backUrl = '', $storeId = '0')
    {
        ...
        $CouponExpiryDate=date("d-M-Y", strtotime("+7 days"));
        //$code=$this->generateCode();
        //$websiteId=Mage::getModel('core/store')->load($storeId)->getWebsiteId(); 
        
        //$voucher=$this->getVoucher($code,$websiteId);
		...
		$vars['cust_email']=$customerEmail;
		$vars['customer_password']=$newPassword;
		$vars['cust_name'] = $customerName;
        //$vars['expiry_date']=$CouponExpiryDate;
        //$vars['coupon_code']=$code;
    ...
    /*Added By :Saurabh Sharma - Jan 24th 2012
     * Method getVoucher is For Generate Random Coupon
     */
    
    public function getVoucher($code,$websiteId)
    {
		$createdAt = date('Y-m-d');
		$expiryDate = date("Y-m-d", strtotime("+7 days"));
        $condition = addslashes('a:7:{s:4:"type";s:32:"salesrule/rule_condition_combine";s:9:"attribute";N;s:8:"operator";N;s:5:"value";s:1:"1";s:18:"is_value_processed";N;s:10:"aggregator";s:3:"all";s:10:"conditions";a:1:{i:0;a:5:{s:4:"type";s:32:"salesrule/rule_condition_address";s:9:"attribute";s:13:"base_subtotal";s:8:"operator";s:2:">=";s:5:"value";s:3:"750";s:18:"is_value_processed";b:0;}}}');
        $actions = addslashes('a:6:{s:4:"type";s:40:"salesrule/rule_condition_product_combine";s:9:"attribute";N;s:8:"operator";N;s:5:"value";b:1;s:18:"is_value_processed";N;s:10:"aggregator";s:3:"all";}');
        $data = Mage::getSingleton('core/resource')->getConnection('core_write');
        $sql = "insert into salesrule (`name`, `description`, `from_date`, `to_date`, `uses_per_customer`, `customer_group_ids`, `is_active`, `conditions_serialized`, `actions_serialized`, `stop_rules_processing`, `is_advanced`, `product_ids`, `sort_order`, `simple_action`, `discount_amount`, `discount_qty`, `discount_step`, `simple_free_shipping`, `apply_to_shipping`, `times_used`, `is_rss`, `website_ids`, `coupon_type`) value ('On Registration', 'Coupon generated at the time of registration.', '".$createdAt."', '".$expiryDate."', 1, 1, 1, '".$condition."', '".$actions."', 0, 1, NULL, 0, 'cart_fixed', '300.0000', NULL, 0, 0, 0, 0, 0, '".$websiteId."', 2)"; 
        $data->query($sql);
        
        $ruleId=$data->lastInsertId();
        $salesruleCoupon=Mage::getModel('salesrule/coupon')
                ->setRuleId($ruleId)
                ->setCode($code)
                ->setUsageLimit(1)
