...
//        }
    ...
    /*For marketplace */
    public function getCategoriesForMarketplace($parent, $recursionLevel = 0, $sorted=false, $asCollection=false, $toLoad=true)
    {
        $categories = $this->getResource()
            ->getCategoriesForMarketplace($parent, $recursionLevel, $sorted, $asCollection, $toLoad);
        return $categories;
    }
