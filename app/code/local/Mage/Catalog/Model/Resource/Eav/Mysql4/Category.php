...
class Mage_Catalog_Model_Resource_Eav_Mysql4_Category extends Mage_Catalog_Model_Resource_Eav_Mysql4_Abstract
{
    ...
    /**
     * Retrieve categories for marketplace which are not in include menu
     * 
     */
    public function getCategoriesForMarketplace($parent, $recursionLevel = 0, $sorted=false, $asCollection=false, $toLoad=false)
    {
        $tree = Mage::getResourceModel('catalog/category_tree');
        /** @var $tree Mage_Catalog_Model_Resource_Eav_Mysql4_Category_Tree */
        $nodes = $tree->loadNode($parent)
