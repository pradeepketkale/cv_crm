...
class Mage_Catalog_Block_Category_View extends Mage_Core_Block_Template
{
    protected function _prepareLayout()
    {
        ...
        if ($headBlock = $this->getLayout()->getBlock('head')) {
            ...
            if ($title = $category->getName()) {
                /*Craftsvilla Comment
                 * Added Pagination page no to title
                 * added by suresh on 29-06-2012
                 */
            	if($_GET['p'])
                {
					$headBlock->setTitle("Page ".$_GET['p']." of ".$title." - Craftsvilla");                	
                }
                else {
            ...
            if ($description = $category->getMetaDescription()) {
            	if($_GET['p'])
                {
					$headBlock->setDescription("Page ".$_GET['p']." of ".$title." - Craftsvilla");                	
                }
            	else {
