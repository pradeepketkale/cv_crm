...
class Mage_CatalogInventory_Model_Observer
{
    ...
    protected function _prepareItemForSave($item, $product)
    {
        ...
        $qty = $item->getQty();
        $sql = "insert into cataloginventory_stock_item_audit(product_id,lastQty,changetype,changedQty,newQty,userId) values('$product_id','$originalQty','ModifyQty','$qty','$qty','$curUser')";
