	...
	<div class="grid grid-pad">
		<div class="col-1-1">
			<div class="container-wrapper2">
				...
				<h2>PreformaCode</h2>
					<form action='/financereport/financereport/preFormacode' method='POST' name="myForm">
						<table  width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl_rptjen">

							<tr>
								<td style="text-align:center;" >
									<b>Enter Vendor ID: </b><input type="text"  tabindex="1" size="9" value="" class="field text datpik" name="vendor_id" id="vendorid">
								</td>
							</tr>
							<tr>
								<td style="text-align:center;" >
