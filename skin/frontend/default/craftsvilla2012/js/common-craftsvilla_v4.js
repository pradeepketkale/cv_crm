    ...
    jQuery(function(){
        ...
        jQuery("#search").unbxdautocomplete({
            ...
            ,onSimpleEnter : function(){
                window.location = '//search.craftsvilla.com?q=' + encodeURIComponent(this.input.value);
            }
            ,onItemSelect : function(data,original){
                ...
                if(data.type == "IN_FIELD")
                {
                        if(data.filtername)
                        {
                            ...
                            if (data.filtername == "brand")
                            {
                                filtername = "brand_fq";
                            }

                            window.location = '//search.craftsvilla.com?q='+encodeURI(data.value)+'&filter='+ filtername + ':' + encodeURI(data.filtervalue) ;
                        }
