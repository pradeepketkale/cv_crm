    ...
    if(array.length>0)
    {
		...
		//	alert(array[i]['payment_method']);
          ...
          if(array[i]['payment_method'] == 0)
			{
				str += '<li class="item first"><div class="prCnr"><div class="codimage3" style="float:right;">COD<img align="texttop" border="0" src="http://local.craftsvilla.com/doejofinal/skin/frontend/default/craftsvilla2012/images/tickforcod.png"/></div>';
			} 
					else{
