            ...
            onComplete:  function(resp) {
                if (typeof(resp.responseText) == 'string') {
                    try {
                        ...
                        /*Start...
                    	 * Craftsvilla Comment
                    	 * Added code for reload cart item count and price in header cart link
                    	 * Added by Suresh on 29-05-2012
                    	 */
                    	document.getElementById('cartcountdispval').innerHTML = '';
                        document.getElementById('cartcountdispval').innerHTML = resp.links;
                        /*End...
                    	 * Craftsvilla Comment
                    	 * Added code for reload cart item count and price in header cart link
                    	 * Added by Suresh on 29-05-2012
