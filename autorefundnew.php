...
$shipmentpayout_report1 = Mage::getModel('shipmentpayout/shipmentpayout')->getCollection();
      	$shipmentpayout_report1->getSelect()
				...
				->where('(sales_flat_order_payment.method IN ("secureebs_standard","purchaseorder")) AND (a.udropship_status = 23) AND (main_table.refundtodo > 10)');// a.udropship_status IN (1,15,17)
...
*/      $statuses = Mage::getSingleton('udropship/source')->setPath('shipment_statuses')->toOptionHash();			
	echo "Total Shipments to Refund:";
	echo $shipmentpayout_report1->count(); exit;
