...
$clientDetails = Mage::helper('fedexcourier')->getClientInfo();
	if($var == 'key') Return 'loM2hp8EMN1WJ06W'; 
	if($var == 'password') Return 'MLbgtBsfYmqARP7YYDf2B8WmL'; 
	if($var == 'shipaccount') Return '619389786';
	if($var == 'billaccount') Return '619389786'; 
	...
	if($var == 'trackingnumber') Return 'XXX'; //772834777432
